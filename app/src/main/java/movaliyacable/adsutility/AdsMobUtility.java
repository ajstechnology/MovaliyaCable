package movaliyacable.adsutility;
...
public class AdsMobUtility {
    ...
    public static final String APP_ID ="@string/admob_app_id";
    public static final String INTERSTITAL_ADS_UNIT ="@string/banner_home_footer";
